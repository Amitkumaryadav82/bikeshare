...
from bikeshare_model.processing.validations import validate_inputs
...
if __name__ == "__main__":
    ...
    data_in={"dteday": ["2012-12-23"], "season": ["spring"], "hr": ["8am"], "holiday": ["No"], "weekday": ["Sun"], "workingday": ["No"],
            "weathersit": ["Clear"], "temp": [-1.42], "atemp": [-5.0], "hum": [69], "windspeed": [7.0015], "casual": [5], "registered": [43]}
